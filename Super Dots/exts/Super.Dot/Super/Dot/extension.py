        ...
        with self._window.frame:
            with ui.VStack():
                ...
                with ui.HStack():
                    ...
                    ui.StringField(model=self._source_prim_model_two,
                        height=0)
                    # Button that puts the selection to the string field
                    ui.Button(
                        " S ",
                ...
                with ui.HStack():
                    ...
                    style={
                        ...
                        "font_size":20},
                    clicked_fn=lambda: on_click_snap(Gf.Vec3d(1,1,1)))
                    ui.Button(
                    "X",
                    style={
                        ...
                        "border_width": 2}, 
                    clicked_fn=lambda: on_click_snap(Gf.Vec3d(1,0,0)))
                    ui.Button(
                    "Y",
                    style={"background_color": 0x9900FF00, 
                        "color": 0xFF000000, 
                        "font_size":20,
                        "border_color": 0xFF000000,
                        "border_width": 2}, 
                    clicked_fn=lambda: on_click_snap(Gf.Vec3d(0,1,0)))
                    ui.Button(
                    "Z",
                    style={
                        ...
                        "border_color": 0xFF000000,
                        "border_width": 2}, 
                    clicked_fn=lambda: on_click_snap(Gf.Vec3d(0,0,1)))
